Public Class CommandManager
    ...
    Public Shared Function BuildCommand(bytes As Byte(), ByRef cmd As BaseCommand, ByRef packetNumber As Integer, ByRef offset As Integer) As Boolean

        For startPosition = 0 To bytes.Length - 1
